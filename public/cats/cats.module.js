...
const cat_schemas_1 = require("./schemas/cat.schemas");
let CatsModule = exports.CatsModule = class CatsModule {
};
exports.CatsModule = CatsModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: cat_schemas_1.Cat.name, schema: cat_schemas_1.CatSchema }])],
